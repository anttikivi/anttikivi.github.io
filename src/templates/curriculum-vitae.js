      ...
      <div className={`${styles.contentMargin} ${cvStyles.content}`}>
        ...
        <div className={cvStyles.columns}>
          <div className={cvStyles.mainColumn}>
            ...
            <h3>{i("cv_work_experience_defence_force_title")}</h3>

            <h4>{i("cv_work_experience_defence_force_job")}</h4>
            <p>
          ...
          <div className={cvStyles.sideColumn}>
            ...
            <h4>{i("cv_education_university_of_helsinki_title")}</h4>
            <p>
              <em>
            ...
            <h3>{i("cv_education_reserve_officer_degree")}</h3>
            <h4>{i("cv_education_reserve_officer_course_title")}</h4>

            <h3>{i("cv_education_tikkurilan_lukio_degree")}</h3>
            <h4>{i("cv_education_tikkurilan_lukio_title")}</h4>
            <p>
