...
export const curriculumVitaeMessages = {
  ...
  <p>
    Since summer 2019, I’ve worked as a part-time communications entrepreneur
    with two of my friends. In our firm I hold the post of a member of the board
    and work as the firm’s CEO.
  </p>
  <p>
    My speciality is writing and designing websites. In addition to that, I’m
    responsible for the firm’s management and finances and therefore I keep the
    company’s bookkeeping.
  </p>
  `,
  cv_work_experience_lukiolaiset_title:
    "Union of Upper Secondary School Students in Finland",
  cv_work_experience_lukiolaiset_job: "Vice President",
  ...
  cv_positions_of_trust_ita_vantaan_knl_job: "Member of the Board",
