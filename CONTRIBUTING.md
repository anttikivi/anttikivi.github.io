...
The following is a set of guidelines for contributing to the website. These are mostly guidelines, not rules. Use your best judgment and feel free to propose changes to this document in a pull request.
...
This section guides you through submitting a bug report for the website. Following these guidelines helps the maintainers and the community understand your report :pencil:, reproduce the behaviour :computer: :computer:, and find related reports :mag_right:.
...
- **Check if you can reproduce the problem [in the latest version of the website](https://github.com/anttikivi/anttikivi.github.io/releases/latest).**
...
- **Describe the exact steps which reproduce the problem** in as many details as possible. For example, start by explaining how you built or started the website, e.g. which command exactly you used in the terminal or how you built or started the website otherwise. When listing steps, **don’t just say what you did, but explain how you did it**. For example, if you moved the cursor to the end of a line, explain if you used the mouse, or a keyboard shortcut or an the website command, and if so which one?
...
- **Did the problem start happening recently** (e.g. after updating to a new version of the website) or was this always a problem?
- If the problem started happening recently, **can you reproduce the problem in an older version of the website?** What’s the most recent version in which the problem doesn’t happen? You can download older versions of the website from the [releases page](https://github.com/anttikivi/anttikivi.github.io/releases).
...
- **Include screenshots and animated GIFs** which help you demonstrate the steps or point out the part of the website which the suggestion is related to. You can use [this tool](http://www.cockos.com/licecap) to record GIFs on macOS and Windows, and [this tool](https://github.com/colinkeenan/silentcast) or [this tool](https://github.com/GNOME/byzanz) on Linux.
- **Specify which version of the website you’re using.**
- **Specify the name and version of the OS you’re using.**

### Your First Code Contribution

Unsure where to begin contributing to the website? You can start by looking through these `good first issue` and `help wanted` issues:
